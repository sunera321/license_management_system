        ...
        <div className={`lg:flex flex-grow justify-end items-center ${isOpen ? 'flex' : 'hidden'}`}>
          <ul className="lg:flex lg:space-x-6">
            <li className="relative group">
              <a href="/controlpanel" className="px-4 py-2 text-sm font-medium text-gray-700 transition duration-300 rounded-md group-hover:text-blue-500">Control Panel</a>
