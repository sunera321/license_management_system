...
const Slidebar = () => {
  return (
    ...
    <div className=" bg-slate-900 w-10 bg-custom-gray fixed group hover:w-64 transition-all duration-300 ease-in-out overflow-hidden  top-[55%] transform -translate-y-1/2  rounded">
      ...
      <a href="/components/page/" className="flex items-center justify-center px-4 py-2 transition-colors hover:bg-slate-700">
