...
const Footer = () => {
  return (
    <footer className="to-gray-300 from-[#EEEBEB] bg-gradient-to-l">
        ...
        <div className="flex justify-between ml-14 mr-14">
          <div>
            <a href="https://hsenidbiz.com/" className="items-center">
              ...
              <img src={Company} className="h-[40px] w-[200px] mt-5" alt="company Logo" />
            </a>
          </div>
          ...
          <div className="hidden sm:inline-flex">
            <ul className="text-gray-600 dark:text-gray-600 font-medium text-[13px]">
              ...
              <li className="mb-1">
                <a href="/components/page/" className="hover:underline">Mobile Solution</a>
              </li>
              <li>
                <a href="/components/page/" className="hover:underline">Hospitality Services</a>
              </li>
            </ul>
          </div>
          ...
          <div className="hidden sm:inline-flex">
            <ul className="text-gray-600 dark:text-gray-600 font-medium text-[13px]">
              ...
              <li className="mb-1">
                <a href="/components/page/" className="hover:underline">Privacy Policy</a>
              </li>
              <li>
          ...
          <div className="-ml-5">
            <ul className="font-medium text-gray-900 hover:text-gray-400">
              <li className="mb-3 ml-1">
                <a href="mailto:info@hsenidbiz.com" className="hover:underline">info@hsenidbiz.com</a>
              </li>
              <li className="mb-3 ml-1">
                <a href="tel:+94114621111" className="hover:underline">+94 11 462 1111</a>
              </li>
      ...
      <div className="mx-auto mt-2 text-center">
        <span className="text-sm text-gray-700">© 2023 <a href="https://hsenidbiz.com/" className="hover:underline">hSenidBiz.com</a>. All Rights Reserved.</span>
      </div>
    </footer>
  );
}
