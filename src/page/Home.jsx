  ...
  return (
    <>
      <section className='flex flex-col items-center justify-between w-full h-auto gap-4 bg-center bg-cover lg:flex-row lg:h-screen' style={{backgroundImage: `url(${backgroundImg})`}}>
        ...
        <div className='flex flex-col items-start justify-center gap-10 px-6 py-10 lg:h-1/2 lg:px-20 lg:items-start lg:ml-16'>
          <h1 className='text-xl font-bold text-slate-50 sm:text-2xl lg:text-5xl  mr-60 lg:text-left'>License Key<br/> Management System</h1>
      ...
      <section id='services' className='flex flex-col items-center justify-center w-full h-full bg-center bg-cover bg-slate-900'>
        ...
        <div className="py-10 text-center lg:py-20">
          <h1 className="text-xl font-bold text-white sm:text-2xl lg:text-4xl">Our Products and Services</h1>
        </div>
        
        {/* Content with four images */}
        <div className="flex flex-col items-center justify-center w-full px-3 py-10 space-y-10 sm:flex-row sm:flex-wrap sm:px-10 md:px-16 lg:flex-nowrap lg:px-20 lg:space-y-0 lg:space-x-10">
          {/* Image 1 */}
          <div className="flex flex-col items-center text-center w-full sm:w-1/2 lg:w-1/4 px-4">
            <img src={image1} alt="Product 1" className="object-cover w-2/3 h-auto sm:w-3/4 lg:w-1/2 lg:h-1/2" />
          ...
          {/* Image 2 */}
          <div className="flex flex-col items-center text-center w-full sm:w-1/2 lg:w-1/4 px-4">
            <img src={image2} alt="Product 2" className="object-cover w-2/3 h-auto sm:w-3/4 lg:w-1/2 lg:h-1/2" />
          ...
          {/* Image 3 */}
          <div className="flex flex-col items-center text-center w-full sm:w-1/2 lg:w-1/4 px-4">
            <img src={image3} alt="Product 3" className="object-cover w-2/3 h-auto sm:w-3/4 lg:w-1/2 lg:h-1/2" />
          ...
          {/* Image 4 */}
          <div className="flex flex-col items-center text-center w-full sm:w-1/2 lg:w-1/4 px-4">
            <img src={image4} alt="Product 4" className="object-cover w-2/3 h-auto sm:w-3/4 lg:w-1/2 lg:h-1/2" />
