import React  from 'react';
    ...
    return (
        <div>
         ...
         <h1 className='my-8 mt-10 mb-8 font-serif text-3xl md:text-4xl lg:text-4xl font-bold text-center text-black fill-gray-400'>Edit Client Profile</h1>
            ...
            <div className='px-10 md:px-20 lg:px-40 mx-auto max-w-6xl'>
                <form className='px-5 pt-2 pb-20 bg-gray-100 rounded shadow-lg '>
                    <div className="mb-6 ">
                        ...
                        <input type="text"  name="ClientID" className='w-full px-100 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline' /> <br />
                    </div>
                    <div className='mb-6'>
