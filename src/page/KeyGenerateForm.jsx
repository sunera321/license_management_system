           ...
           <PageHeader title='Key Generate' />
            <div className=''>
                <form className='w-3/5 px-10 pt-10 pb-20 mx-auto mb-10 bg-gray-100 rounded shadow-lg '>
                    ...
                    <button id='submit' type='submit' className="items-end w-48 p-2 mt-10 font-bold text-white bg-blue-900 rounded-md shadow-xl mb-28 hover:bg-indigo-500">SUBMIT</button>
                    </div>
                </form>
            </div>
        </div>
