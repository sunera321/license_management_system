          ...
          <div className="text-center lg:text-left">
            ...
            <div>
              ...
              <div className="flex items-center mt-10 logo-and-button">
                ...
                <button className="px-4 py-2 text-black bg-gray-100 rounded-lg btn hover:bg-gray-300 hover:text-gray-800" onClick={handleSignIn}>Sign in with Microsoft</button>
              </div>
            </div>
          </div>
        </div>
